...
const HeroSection = () => {
  ...
  return (
    <div className="relative  pt-18 sm:pt-0 sm:h-138 bg-brandAccent">
      ...
      <div className="flex-col md:flex-row flex justify-between items-center px-2 sm:px-12 md:px-25">
        <div>
        ...
        <Image
          ...
          width={800}
          height={500}
          className=" md:h-90 md:w-135 xl:h-135 xl:w-185  sm:translate-y-2.5"
          priority
        />
      </div>
    </div>
