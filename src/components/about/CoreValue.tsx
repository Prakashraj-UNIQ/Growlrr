"use client";
import { ShieldCheck, Beaker, Heart, Leaf } from "lucide-react";
...
const VALUES_ENHANCED: Value[] = [
  {
    title: "Integrity",
    desc:
      "Human-grade inputs, full traceability, and alignment with AAFCO/FEDIAF.",
    icon: ShieldCheck,
  },
  {
    title: "Innovation",
    desc:
      "Patented modular architecture plus digital personalization for every pet.",
    icon: Beaker,
  },
  {
    title: "Empathy",
    desc:
      "Built around real pets and parents, guided by veterinary insight.",
    icon: Heart,
  },
  {
    title: "Sustainability",
    desc:
      "Retort-sterilized pouches (no cold chain), smart sourcing, minimal waste.",
    icon: Leaf,
  },
];
