...
export default function AboutUs() {
  return (
    <section className="w-full bg-amber-50 py-4 px-2 lg:px-25">
      <div className="relative w-full grid grid-cols-1 lg:grid-cols-2 items-center bg-brandAccent sm:bg-transparent rounded-full">
        {/* Right Image */}
        ...
        {/* Left Content */}
        <div className="sm:absolute space-y-6 bg-brandAccent text-center sm:text-start rounded-full  sm:pl-100 md:pl-120 sm:pr-12 py-10 sm:py-20">
          ...
          <button className="cursor-pointer px-5 py-2 rounded-full bg-brandOrange text-white sm:mr-3">
            Know More
          </button>
        </div>
      </div>
