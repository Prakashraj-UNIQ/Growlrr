...
export default function AboutUs() {
  return (
    <section className="w-full bg-amber-50 py-4 px-2 lg:px-25">
      <div className="relative w-full grid grid-cols-1 md:grid-cols-2 items-center sm:bg-transparent rounded-full">
        {/* Right Image */}
        <div className="flex z-1 justify-start md:justify-center">
          <Image
            src="/images/aboutSectionBg.png"
            alt="About Growlrr Foods"
            width={500}
            height={400}
            className=" object-cover relative md:bottom-30"
          />
        </div>
        {/* Left Content */}
        <div className="md:absolute space-y-6 lg:bg-brandAccent text-center sm:text-start rounded-full  sm:pl-100 md:pl-120 sm:pr-12 py-10 sm:py-20">
          ...
          <p className="text-gray-800 sm:text-lg leading-relaxed sm:p-0 text-justify">
